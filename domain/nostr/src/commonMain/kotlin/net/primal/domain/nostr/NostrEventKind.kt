...
enum class NostrEventKind(val value: Int) {
    ...
    PrimalImportEventsResult(value = 10_000_127),
    ...
    PrimalInvoicesToZapRequests(value = 10_000_177),
    PrimalPollStats(value = 10_000_179),
    PrimalParsedAdvancedSearch(value = 10_000_180),
