...
val appVersionCode = 2646
val appVersionName = "2.6.5"
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField(
            ...
            value = "\"${project.findProperty("bugstrDevPubkey") ?: "npub1zafcms4xya5ap9zr7xxr0jlrtrattwlesytn2s42030lzu0dwlzqpd26k5"}\"",
        )
