...
class NotePublishHandlerTest {
    ...
    @Test
    fun `publishShortTextNote publish new note`() = runTest {
    ...
    @Test
    fun `publishShortTextNote publish reply to note`() = runTest {
    ...
    @Test
    fun `publishShortTextNote publish reply to reply to note`() = runTest {
        val rootPostId = "somePostId"
    ...
    @Test
    fun `publishShortTextNote publish new note with single user mentioned`() = runTest {
    ...
    @Test
    fun `publishShortTextNote publish new note with multiple users mentioned`() = runTest {
    ...
    @Test
    fun `publishShortTextNote publish new note with single user mentioned multiple times`() = runTest {
        val mentionedUserNpub = "nostr:npub16c0nh3dnadzqpm76uctf5hqhe2lny344zsmpm6feee9p5rdxaa9q586nvr"
    ...
    @Test
    fun `publishShortTextNote publish new note with single quoted note`() = runTest {
    ...
    @Test
    fun `publishShortTextNote publish new note with multiple quoted notes`() = runTest {
    ...
    @Test
    fun `publishShortTextNote publish new note with single quoted note repeating`() = runTest {
        val quotedNoteUri = "nostr:note1x0zvuxjz8fjagqlssu0gl5npnas67475tqcqsrzs56yk2625f3as6f0rpt"
        val quotedNoteId = "33c4ce1a423a65d403f0871e8fd2619f61af57d45830080c50a6896569544c7b"
    ...
    @Test
    fun `publishShortTextNote publish new note with single quoted article`() = runTest {
        val naddr = Naddr(
    ...
    @Test
    fun `publishShortTextNote publish new note with multiple quoted articles`() = runTest {
    ...
    @Test
    fun `publishShortTextNote publish new note with single quoted article repeating`() = runTest {
        val naddr = Naddr(
            kind = NostrEventKind.LongFormContent.value,
            userId = "88cc134b1a65f54ef48acc1df3665063d3ea45f04eab8af4646e561c5ae99079",
            identifier = "Testing-Testing-Testing-8yw62n",
    ...
    @Test
    fun `publishShortTextNote publish new note with single quoted highlight and article`() = runTest {
    ...
    @Test
    fun `publishShortTextNote publish new note with multiple quoted highlights and article`() = runTest {
    ...
    @Test
    fun `publishShortTextNote publish new note with single quoted highlight and article repeating`() = runTest {
        val highlightNevent = Nevent(
            kind = NostrEventKind.Highlight.value,
            userId = "d61f3bc5b3eb4400efdae6169a5c17cabf3246b514361de939ce4a1a0da6ef4a",
            eventId = "54499bd42e570d428ce1acfd5842a61e09e570a339c68195ffcccf69cd9b48ec",
        ...
        val expectedUserId = "someUserId"
        val expectedContent =
            "some simple content nostr:${highlightNevent.toNeventString()} nostr:${highlightNevent.toNeventString()} ${naddr.toNaddrString()}"
        val expectedTags = listOf<JsonArray>(
