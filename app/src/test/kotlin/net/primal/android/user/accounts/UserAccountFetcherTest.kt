...
class UserAccountFetcherTest {
    ...
    @Test
    fun fetchUserProfile_fetchesUserDetailsForGivenPubkey() =
        runTest {
    ...
    @Test
    fun fetchUserProfile_updatesUserProfileInDatabase() =
        runTest {
            val usersApiMock = buildMockUserApi()
            val fetcher = UserAccountFetcher(
                dispatcherProvider = coroutinesTestRule.dispatcherProvider,
    ...
    @Test
    fun fetchUserProfile_updatesUserProfileStatsInDatabase() =
        runTest {
            val usersApiMock = buildMockUserApi()
            val fetcher = UserAccountFetcher(
                dispatcherProvider = coroutinesTestRule.dispatcherProvider,
    ...
    @Test
    fun fetchUserFollowList_fetchesUserFollowListForGivenPubkey() =
        runTest {
