...
class NostrUnsignedEventExtTest {
    ...
    fun `sign returns correct signature`() {
        val expectedSig = "14e5c298d639ab4285452707d8e6b212e4554b8381bb0a312fa87d6bf5ae954bfadf13a9a69b9b5aac3dd37ea6d6020e07ae860e686fce804a408f49ce3c9765"
        val unsignedEvent = NostrUnsignedEvent(
            content = "{\"description\":\"Sync app settings\"}",
            kind = 30078,
            tags = listOf(buildJsonArray {
        ...
        val signedEvent = unsignedEvent.signOrThrow("nsec18c2dg4s9j7ndlujesf4fq5m3ty6u92jpqffuckf75xyyxqsqy4pstyzq4l")
