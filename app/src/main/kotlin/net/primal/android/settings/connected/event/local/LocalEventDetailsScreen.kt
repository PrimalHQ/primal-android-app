...
@Composable
fun LocalEventDetailsScreen(viewModel: LocalEventDetailsViewModel, onClose: () -> Unit) {
...
@Composable
fun LocalEventDetailsScreen(state: LocalEventDetailsContract.UiState, onClose: () -> Unit) {
    PrimalScaffold(
        topBar = {
            PrimalTopAppBar(
