...
@HiltViewModel
class RemoteEventDetailsViewModel @Inject constructor(
    ...
    private val _state = MutableStateFlow(RemoteEventDetailsContract.UiState())
    val state = _state.asStateFlow()
    private fun setState(reducer: RemoteEventDetailsContract.UiState.() -> RemoteEventDetailsContract.UiState) =
    ...
    private fun observeSessionEvent() =
        viewModelScope.launch {
            sessionEventRepository.observeRemoteEvent(eventId = eventId).collect { sessionEvent ->
