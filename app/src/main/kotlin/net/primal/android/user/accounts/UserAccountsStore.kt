...
class UserAccountsStore @Inject constructor(
    ...
    ): UserAccount = writeMutex.withLock {
    ...
    suspend fun upsertAccount(userAccount: UserAccount) = writeMutex.withLock {
    ...
    suspend fun deleteAccount(pubkey: String) = writeMutex.withLock {
        persistence.updateData { accounts ->
    ...
    suspend fun clearAllAccounts() = writeMutex.withLock {
