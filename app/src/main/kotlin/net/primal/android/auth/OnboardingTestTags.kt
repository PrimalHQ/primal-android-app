...
object OnboardingTestTags {
    ...
    const val CREATE_ACCOUNT_NOW_BUTTON = "onboardingCreateAccountNowButton"
    const val DONE_BUTTON = "onboardingDoneButton"
    const val FOLLOW_ALL_BUTTON = "onboardingFollowAllButton"
}
