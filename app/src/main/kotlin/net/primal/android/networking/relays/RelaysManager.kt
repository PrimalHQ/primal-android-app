...
class RelaysManager @Inject constructor(
    ...
    private suspend fun updateRelayPools(
        ...
        if (walletRelaysChanged) relayPoolsMutex.withLock {
    ...
    private suspend fun clearRelayPools() = relayPoolsMutex.withLock {
        regularRelaysPool?.closePool()
        regularRelaysPool = null
        walletRelaysPool?.closePool()
        walletRelaysPool = null
