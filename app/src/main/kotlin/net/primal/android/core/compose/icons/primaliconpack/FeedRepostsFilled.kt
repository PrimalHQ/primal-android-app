...
public val PrimalIcons.FeedRepostsFilled: ImageVector
    get() {
        if (_feedRepostsFilled != null) {
            return _feedRepostsFilled!!
        }
        _feedRepostsFilled = Builder(name = "Feedrepostsfilled", defaultWidth = 18.0.dp,
                defaultHeight = 18.0.dp, viewportWidth = 18.0f, viewportHeight = 18.0f).apply {
            path(fill = SolidColor(Color(0xFF66E205)), stroke = null, strokeLineWidth = 0.0f,
...
private var _feedRepostsFilled: ImageVector? = null
