...
public val PrimalIcons.FeedZapsFilled: ImageVector
    get() {
        if (_feedZapsFilled != null) {
            return _feedZapsFilled!!
        }
        _feedZapsFilled = Builder(name = "Feedzapsfilled", defaultWidth = 18.0.dp, defaultHeight =
                18.0.dp, viewportWidth = 18.0f, viewportHeight = 18.0f).apply {
            group {
                path(fill = SolidColor(Color(0xFFFF9F2F)), stroke = null, strokeLineWidth = 0.0f,
...
private var _feedZapsFilled: ImageVector? = null
