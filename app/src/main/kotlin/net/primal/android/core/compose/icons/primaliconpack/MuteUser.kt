...
public val PrimalIcons.MuteUser: ImageVector
    get() {
        if (_muteuser != null) {
            return _muteuser!!
        }
        _muteuser = Builder(name = "Muteuser", defaultWidth = 20.0.dp, defaultHeight = 20.0.dp,
...
private var _muteuser: ImageVector? = null
