...
val PrimalIcons.ContextShowHighlightsOutlined: ImageVector
    get() {
        if (_ContextShowHighlightsOutlined != null) {
            return _ContextShowHighlightsOutlined!!
        }
        _ContextShowHighlightsOutlined = ImageVector.Builder(
            name = "ContextShowHighlightsOutlined",
            defaultWidth = 20.dp,
            defaultHeight = 20.dp,
            viewportWidth = 20f,
            viewportHeight = 20f
            ...
            path(
                ...
                lineTo(5.242f, 18.668f)
                curveTo(5.025f, 18.881f, 4.731f, 19f, 4.425f, 19f)
                lineTo(1.158f, 19f)
                curveTo(0.128f, 19f, -0.387f, 17.78f, 0.341f, 17.067f)
                lineTo(2.453f, 14.997f)
                lineTo(5.72f, 18.199f)
                close()
                moveTo(7.717f, 18.343f)
                curveTo(9.213f, 19.118f, 11.143f, 18.727f, 12.174f, 17.284f)
                ...
                curveTo(7.137f, 17.987f, 7.419f, 18.188f, 7.717f, 18.343f)
                close()
                moveTo(17.74f, 3.257f)
                curveTo(16.837f, 2.372f, 15.403f, 2.246f, 14.349f, 2.969f)
                lineTo(4.235f, 9.908f)
                curveTo(3.243f, 10.589f, 3.129f, 11.957f, 3.973f, 12.785f)
                lineTo(7.934f, 16.667f)
                curveTo(8.804f, 17.52f, 10.256f, 17.389f, 10.953f, 16.413f)
                lineTo(18.033f, 6.499f)
                curveTo(18.75f, 5.494f, 18.632f, 4.132f, 17.74f, 3.257f)
                close()
            }
...
private var _ContextShowHighlightsOutlined: ImageVector? = null
