...
public val PrimalIcons.PhotoFromGallery: ImageVector
    get() {
        if (_photoFromGallery != null) {
            return _photoFromGallery!!
        }
        _photoFromGallery = Builder(name = "Photo from gallery", defaultWidth = 24.0.dp,
...
private var _photoFromGallery: ImageVector? = null
