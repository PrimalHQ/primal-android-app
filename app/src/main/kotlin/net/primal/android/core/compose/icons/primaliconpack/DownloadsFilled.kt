...
public val PrimalIcons.DownloadsFilled: ImageVector
    get() {
        if (_downloadsfilled != null) {
            return _downloadsfilled!!
        }
        _downloadsfilled = Builder(name = "Downloadsfilled", defaultWidth = 24.0.dp, defaultHeight =
...
private var _downloadsfilled: ImageVector? = null
